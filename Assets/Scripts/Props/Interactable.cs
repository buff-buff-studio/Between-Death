...
namespace Refactor.Props
{
    ...
    public class Interactable : MonoBehaviour
    {
        ...
        {
            foreach (var collider in GetComponents<Collider>()) collider.enabled = value;
            this.enabled = value;
        }
        
        public void SetEnabledInverse(bool value)
        {
            SetEnabled(!value);
        }
...
public class InteractableEditor : Editor
{
    ...
    protected bool ColliderProperty(Interactable target)
    {
